...
find "$desination_path" -type f -path '*dist*' -mmin -360 -print | sed \
 -e "s|^${desination_path}/packagecloud.io/shiftkey/desktop/any|ghd/deb|" \
 -e "s|^${desination_path}/grimler.se/termux-packages-24|termux/main|" \
 -e "s|^${desination_path}/grimler.se/termux-root-packages-24|termux/root|" \
 -e "s|^${desination_path}/grimler.se/x11-packages|termux/x11|" \
 -e "s|^${desination_path}/apt.retorque.re/file/zotero-apt|zotero/deb|" | 
